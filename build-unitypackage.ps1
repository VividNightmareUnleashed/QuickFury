# Builds QuickFury-<version>.unitypackage from com.quickfury.addon.
...
$out = Join-Path $repo "QuickFury-$version.unitypackage"

function Get-Guid([string]$relPath) {
    $md5 = [System.Security.Cryptography.MD5]::Create()
    $bytes = $md5.ComputeHash([System.Text.Encoding]::UTF8.GetBytes("com.quickfury.addon:" + $relPath))
